...
export function ErrorMessage({ errorCode, locale }: ErrorMessageProps) {
  ...
  return (
    <div className="text-[#ff5555] bg-[rgba(255,85,85,0.1)] border-2 border-[#ff5555] rounded-[10px] p-5 mt-5 max-w-150 text-left text-[0.95rem] leading-relaxed">
